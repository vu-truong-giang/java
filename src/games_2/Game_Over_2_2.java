...
public class Game_Over_2_2 extends JFrame implements ActionListener {
    ...
    public Game_Over_2_2 (SnakeGame_2_2 snakeGame_2_2) throws HeadlessException {
  	  this.snakeGame_2_2 = snakeGame_2_2;
  	  this.init();
    ...
    public void init() {
  	  ...
  	  Label scoreLabel = new Label("Score:"+snakeGame_2_2.calculateScore());
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				// TODO Auto-generated method stub
				SnakeGame_2_2 snakGame_2_2 = new SnakeGame_2_2(600, 600);
			
				//Home home = new Home();
				Game_Over_2_2 game_Over = new Game_Over_2_2(snakGame_2_2);
