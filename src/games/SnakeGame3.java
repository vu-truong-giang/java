...
public class SnakeGame3 extends JPanel implements ActionListener, KeyListener {
    ...
    public SnakeGame3(int boardWidth, int boardHeight) {
...
//	
    ...
    public void actionPerformed(ActionEvent e) {
        if(!gameOver) {
        	...
        	gameLoop.stop();
        	SwingUtilities.invokeLater(()-> new Game_Over3(this));// chuyển sang Game_Over
